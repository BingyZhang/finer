...
"Πατάτες",        "Πατάτες τηγανητες",
"Μπιφτέκια",        "Μπιφτέκια, κεμπάπ, κεφτέδες",
"Γεμιστά",        "Γεμιστά",
"Μουσακάς",        "Μουσακάς",
...
"Γιουβαρλάκια",        "Γιουβαρλάκια",
"Σουτζουκάκια",        "Σουτζουκάκια",
...
"Φρικασέ",        "Φρικασέ",
"Στιφάδο",        "Στιφάδο",
"Λουκάνικο",        "Λουκάνικο μόνο του ή σε συνταγή",
"Λεμονάτο",        "Κρέας λεμονάτο",
"Πάπια", "Πάπια με πορτοκάλι ή άλλο τρόπο",
...
"Άλλο",        "Οτιδήποτε δεν περιλαμβάνεται στις υπόλοιπες κατηγορίες ήσυνταγές",
]
...
"Ευ.Ελευθ.Συμ.",	"Ευρωπαϊκή Ελεύθερη Συμμαχία - Ουράνιο Τόξο",
