...
party_list1 = [
"Πίτσα", "Πίτσα",
"Μακαρόνια", "Μακαρόνια ή άλλα ζυμαρικά",
"Σουβλάκι", "Σουβλάκι (σε όλες τις παραλλαγές)",
"Πατάτες", "Πατάτες - Τηγανητες, Πουρέ κλπ.",
"Μπιφτέκια", "Μπιφτέκια, κεμπάπ, κεφτέδες, σουτζουκάκια",
"Γεμιστά", "Γεμιστά",
"Μουσακάς", "Μουσακάς",
"Ντολμάδες", "Ντολμάδες με όλα τα δυνατά είδη φύλλου",
"Ψάρι", "Ψάρι ψητό ή τηγανητό",
"Ψαρόσουπα", "Ψαρόσουπα",
"Αρνί Κατσ.", "Αρνί ή κατσίκι ψητό",
"Κοκορέτσι", "Κοκορέτσι ή άλλα εντόσθια",
"Κοτόπουλο", "Κοτόπουλο ψητό ή κατσαρόλας",
"Πιτές", "Πίτες - τυρόπιτα, σπανακόπιτα κλπ.",
"Σπανακόρυζο", "Σπανακόρυζο",
"Σαλάτες", "Σαλάτες όλων των ειδών",
"Μπριάμ", "Μπριάμ ή αλλά λαδερά",
"Κοκκινιστό", "Κρέας Κοκκινιστό",
"Θαλασσινά", "Θαλασσινά - χταπόδι, καλαμαράκια κλπ.",
"Όσπρια", "Όσπρια σε σούπα - φασολάδα, φακές κλπ.",
"Γιουβαρλάκ.", "Γιουβαρλάκια",
"Κυνήγι", "Κυνήγι ",
"Ρύζι", "Ρύζι, Ριζότο, Πιλάφι",
#"Αυγό", "Αυγό - βραστό, τηγανητό, ή ομελέτα",
"Χοιρινό", "Χοιρινό στο φούρνο ή κατσαρόλας",
"Μανιτάρια", "Μανιτάρια",
"Φρικασέ", "Φρικασέ",
"Στιφάδο", "Στιφάδο",
"Λουκάνικο", "Λουκάνικο",
"Λεμονάτο", "Κρέας λεμονάτο",
"Αλλαντικά", "Αλλαντικά μόνα τους ή σε συνταγές",
"Σάντουϊτς", "Σάντουϊτς σε διάφορα είδη",
"Μεξικάνικο", "Μεξικάνικη κουζίνα",
"Κινέζικο'", "Κινέζικη κουζίνα",
"Ινδικό", "Ινδική κουζίνα",
"Σούσι", "Σούσι - Γιαπωνέζικη κουζίνα",
"Γαλοπούλα", "Γαλοπούλα Χριστουγεννιάτικη ή με άλλον τρόπο",
"Ψωμί", "Ψωμί ή παράγωγα",
"Τυριά", "Τυριά - διάφορα έιδη",
"Μπριζόλα", "Μπριζόλα μοσχαρίσια ή χοιρινή",
"Άλλο", "Οτίδηποτε δεν περιλαμβάνεται στις υπόλοιπες κατηγορίες ή συνταγές",
]
